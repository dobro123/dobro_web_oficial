...
function modo_oscuro() {
	...
	if(input_modo_oscuro.checked) {
		...
		document.querySelector("html").style.setProperty('--gris_1', '#717177');
		document.querySelector("html").style.setProperty('--gris_2', '#ffffffAA');
		document.querySelector("html").style.setProperty('--blancogrisaseo', '#050505');
		document.querySelector("html").style.setProperty('--gris_3', '#0a0a0a');
		document.querySelector("html").style.setProperty('--gris_3', '#0c0c0c');
	}else {
		...
		document.querySelector("html").style.setProperty('--gris_1', '#e1e1ee');
		document.querySelector("html").style.setProperty('--gris_2', '#00000099');
		document.querySelector("html").style.setProperty('--blancogrisaseo', '#f5f5f5');
		document.querySelector("html").style.setProperty('--gris_3', '#fafafa');
		document.querySelector("html").style.setProperty('--gris_3', '#fcfcfc');
	}
}
...
if(window.matchMedia("(max-width: 480px)").matches) {
	...
	let swith_oscuro = document.querySelector('label span.slider');

	let st = window.pageYOffset || document.documentElement.scrollTop;
		if (st > lastScrollTop){
			navegador_movil.style.transform="translateY(-124%)";
			swith_oscuro.style.transform="translateY(-54px)";
		} else {
			navegador_movil.style.transform="translateY(0%)";
			swith_oscuro.style.transform="translateY(0)";
		}
